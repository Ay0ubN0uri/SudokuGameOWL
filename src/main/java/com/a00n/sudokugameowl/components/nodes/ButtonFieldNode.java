...
import com.a00n.sudokugameowl.components.SudokuInputComponent;
...
public class ButtonFieldNode extends Button {
	...
	public ButtonFieldNode(Field field, int row, int column) {
		...
		setPrefSize(60, 60);
		if(field.isSolution){
			setStyle("-fx-cursor: hand; -fx-text-weight: light; -fx-background-color: green; -fx-opacity: 0.6; -fx-text-fill: #fff;" + getDisabledStyle());
		}
		else{
